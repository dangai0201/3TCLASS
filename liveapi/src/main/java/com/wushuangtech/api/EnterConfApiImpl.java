...
public class EnterConfApiImpl extends EnterConfApi implements ConferenceHelpe {
    ...
    public boolean enterAudioRoom(final String channelKey, final long userId, final long sessionId, final int userRole, final String rtmpUrl, final String sCustom) {
        initRoom(userId, sessionId, userRole, rtmpUrl);
        Runnable runnable = new Runnable() {
            @Override
            public void run() {
                v2ConferenceRequest.requestEnterRoom(
                        mAppId, sessionId, userId, userRole, rtmpUrl, false, sCustom, mHandler);
     ...
     */
    public boolean enterRoom(final String channelKey, final long userId, final long sessionId, final int userRole, final String rtmpUrl , final String sCustom) {
        initRoom(userId, sessionId, userRole, rtmpUrl);
        Runnable runnable = new Runnable() {
            @Override
            public void run() {
                v2ConferenceRequest.requestEnterRoom(
                        mAppId, sessionId, userId, userRole, rtmpUrl, mRecordFlag, sCustom, mHandler);
