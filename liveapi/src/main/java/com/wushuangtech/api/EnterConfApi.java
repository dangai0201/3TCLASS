...
public abstract class EnterConfApi {
     ...
     */
    public abstract boolean enterRoom(String channelKey, long userId, long sessionId, int userRole, String rtmpUrl, String sCustom);

    public abstract boolean enterAudioRoom(String channelKey , long userId, long sessionId, int userRole, String rtmpUrl, String sCustom);
