...
public class JniWorkerThread extends Thread {
    ...
    public static final int JNI_CALL_BACK_ON_UPDATE_USER_INFO = 43;
    public static final int JNI_CALL_BACK_ON_CONNECT_SUCCESS = 44;
                ...
                if (communicationHelper != null) {
                    ...
                    switch (msg.what) {
                        ...
                        case JNI_CALL_BACK_RECONNECT_TIMEOUT:
                            communicationHelper.onConnectionLost();
                            break;
                        case JNI_CALL_BACK_ON_UPDATE_USER_INFO:
                            communicationHelper.OnUpdateUserBaseInfo((long)objs[0] , (long)objs[1] , (String)objs[2]);
                            break;
                        case JNI_CALL_BACK_ON_CONNECT_SUCCESS:
                            communicationHelper.onConnectSuccess((String) objs[0] , (int) objs[1]);
                            break;
                    }
                }
            }
            ...
            if (communicationHelper != null) {
                switch (msgType) {
                    case JNI_CALL_BACK_USER_JOIN:
                        communicationHelper.onUserJoined((long) objs[0], (int) objs[1], (String) objs[2]);
                        break;
