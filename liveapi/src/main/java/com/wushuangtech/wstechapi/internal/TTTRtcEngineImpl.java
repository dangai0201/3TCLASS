...
public class TTTRtcEngineImpl extends TTTRtcEngine implements TTTInterfaceTestCallBack {
    ...
    public TTTRtcEngineImpl(Context mContext, String mAppID,
        ...
        enterConfApi.setup(mAppID, mContext, true, 0);
        //音频模块初始化
...
//        return TTTRtcIjkModule.getInstance().receiveVideoModuleEvent(config);
    ...
    public int joinChannel(String channelKey,
                           String channelName,
                           long optionalUid, String sCustom) {
        ...
        return mWorkerThread.joinChannel(channelKey, channelName, optionalUid , sCustom);
    }
    ...
    public int joinChannel(String channelKey,
                           ...
                           long optionalUid,
                           boolean enableChat,
                           boolean enableSignal, String sCustom) {
        ...
        return joinChannel(channelKey, channelName, optionalUid, sCustom);
    }
        ...
        if (canvas == null) {
            ...
            if (!mIsEnableVideoMode) {
                ...
                if (udc == null) {
                    ...
                    if (!udc.isUse()) {
                        PviewLog.funEmptyError("setupRemoteVideo",
                                "该用户的视频设备未启用,inuse=0", String.valueOf(canvas.getUserID()));
                        result = ERROR_FUNCTION_ERROR_EMPTY_VALUE;
                    }
                    handleVideoModule(new TTTLocalModuleConfig(TTTModuleConstants.VIDEO_OPEN_REMOTE, new Object[]{
    ...
    @Override
    public int updateUserBaseInfo(String sCustom) {
        RoomJni.getInstance().UpdateUserBaseInfo(sCustom);
        return FUNCTION_SUCCESS;
    }
