...
public class HorizontalExpandMenu extends RelativeLayout {
    ...
    private void init(){
        ...
        defaultWidth = Tools.dip2px(mContext,200);
        defaultHeight = Tools.dip2px(mContext,40);
        ...
        menuCornerRadius = typedArray.getDimension(R.styleable.HorizontalExpandMenu_corner_radius,Tools.dip2px(mContext,20));

        buttonStyle = typedArray.getInteger(R.styleable.HorizontalExpandMenu_button_style,Right);
        buttonIconDegrees = 90;
        buttonIconSize = typedArray.getDimension(R.styleable.HorizontalExpandMenu_button_icon_size,Tools.dip2px(mContext,8));
...
//                                expandMenu(expandAnimTime);
     ...
     * @param time 动画时间
     */
    public void expandMenu(int time){
