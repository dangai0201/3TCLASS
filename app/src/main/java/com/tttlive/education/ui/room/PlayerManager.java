...
import com.tttlive.education.util.DebugLog;
import com.tttlive.education.util.LogUtil;

import java.util.HashMap;

import ttt.ijk.media.exo.widget.media.AndroidMediaController;
...
//                        Toaster.show("download rate:" + extra);
            ...
            @Override
            public void onH264SeiReport(String msg) {
                LogUtil.e("onH264SeiReport",msg);
                Log.e("onH264SeiReport",msg);
                playerStateListener.onGetSeiMessage(msg);
            }
        });
...
//            $.id(R.id.app_video_loading).visible();
    ...
    public interface PlayerStateListener{
        ...
        void onGetSeiMessage(String msg);
